package ma.ouakka.cinema.service;

import ma.ouakka.cinema.dao.*;
import ma.ouakka.cinema.entities.*;
...
public class CinemaInitServiceImpl implements ICinemaInitService{
    ...
    public void initFilms() {
        ...
        Stream.of("Baby Driver", "Inception", "Interstellar", "John Wick", 
        		"La liste de Schindler", "Les Évadés", "Mad Max Fury Road", 
        		"Matrix", "The dark knight", "The lord of the ring").forEach(filmTitre -> {
            Film film = new Film();
